[app:app]
use = egg:TestGeoMapFishPackage_geoportal
...
mako.directories = TestGeoMapFishPackage_geoportal:templates
...
[loggers]
keys = root, sqlalchemy, gunicorn.access, gunicorn.error, c2cgeoportal_commons, c2cgeoportal_geoportal, c2cgeoportal_admin, TestGeoMapFishPackage_geoportal, c2cwsgiutils
...
[logger_TestGeoMapFishPackage_geoportal]
level = %(LOG_LEVEL)s
handlers =
qualname = TestGeoMapFishPackage_geoportal
