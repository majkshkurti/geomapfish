[app:app]
use = egg:testgeomapfish_geoportal
...
mako.directories = testgeomapfish_geoportal:templates
...
[loggers]
keys = root, sqlalchemy, gunicorn.access, gunicorn.error, c2cgeoportal_commons, c2cgeoportal_geoportal, c2cgeoportal_admin, testgeomapfish_geoportal, c2cwsgiutils
...
[logger_testgeomapfish_geoportal]
level = %(LOG_LEVEL)s
handlers =
qualname = testgeomapfish_geoportal
